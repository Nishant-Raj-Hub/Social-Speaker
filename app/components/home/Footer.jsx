    ...
    <>
      <section className="pt-16  bg-black">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-6 flex flex-col lg:flex-row justify-between gap-8 border-b border-gray-500">
            <div className="w-full max-lg:mx-auto flex flex-col sm:flex-row max-lg:items-center max-lg:justify-between gap-6 md:gap-12 lg:gap-10">
              <div className="">
                <h6 className="text-lg font-medium text-[#ffdd55] mb-7 max-lg:text-center">
                  Explore Links
                </h6>
                ...
                <ul className="flex flex-col gap-6 max-lg:items-center">
                  <div className="flex  gap-2">
                    ...
                    <div className="flex flex-col">
                      ...
                      <a
                        href="javascript:;"
                        className="text-base font-normal text-gray-400 whitespace-normal transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400 w-80 block"
                      >
                        A-3, 3rd Floor, Above Rajesh Plywood, Rajouri Garden, A
                        Block, Near Raja Garden Chowk, New Delhi, Delhi-110027
                      </a>{" "}
                    </div>
                  </div>
                  <div className="flex  gap-4">
                    ...
                    <div className="flex flex-col">
                      <h6 className="font-semibold text-white">Email Us</h6>
                      <a
                        href="javascript:;"
                        className="text-base font-normal text-gray-400 whitespace-normal transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400 w-80 block"
                      >
                        Hello@peptalkindia.com
                      </a>{" "}
                    </div>
                  </div>
                  <div className="flex  gap-4">
                    ...
                    <div className="flex flex-col">
                      <h6 className="font-semibold text-white">Call Us</h6>
                      <a
                        href="javascript:;"
                        className="text-base font-normal text-gray-400 whitespace-normal transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400 w-80 block"
                      >
           ...
           {/* =
              <h6 className="text-lg font-medium text-[#ffdd55] mb-3 max-lg:text-center">
              Become an PEPTALK Insider
                </h6>
             
              <p className="text-gray-400 ">
                Sign up for exclusive content, emails & things Rocky doesn’t
                share anywhere else.
              </p>
              <div className="bg-gray-800 rounded-3xl p-5 my-5">
                <form action="#" className="flex flex-col gap-5">
                  <div className="relative">
                    <label className="flex  items-center mb-2 text-white text-base font-medium">
                      First Name
                    </label>
                    <input
                      type="text"
                      id="default-search"
                      className="block w-full px-5 py-3 text-lg rounded-md font-normal shadow-xs text-white bg-transparent border border-gray-400  placeholder-gray-400 focus:outline-none leading-relaxed focus-within:border-gray-300"
                      placeholder="Rocky"
                      required=""
                    />
                  </div>
                  <div className="relative">
                    <label className="flex  items-center mb-2  text-base text-white font-medium">
                      Email
                    </label>
                    <input
                      type="text"
                      id="default-search"
                      className="block w-full px-5 py-3 rounded-md text-lg font-normal shadow-xs text-white bg-transparent border border-gray-400  placeholder-gray-400 focus:outline-none leading-relaxed focus-within:border-gray-300"
                  ...
                  <div className="flex flex-col min-[540px]:flex-row items-center justify-between gap-3">
                    <input
                      type="submit"
                      value="LET'S DO IT"
                      className=" text-base font-bold py-2 px-5 rounded-full  cursor-pointer bg-[#ffdd55] transition-all duration-500 text-black"
                    />
                  </div>
                </form>
              </div> */}
...
"
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://www.instagram.com/peptalkindia/?hl=en"
              ...
              <a
                href="https://www.youtube.com/channel/UCHojWKnC2iljNPxKIVleOcg"
                className="p-3 rounded-full bg-white text-gray-700 group transition-all duration-500 hover:bg-amber-500 hover:text-white focus-within:outline-0 focus-within:bg-amber-500 focus-within:text-white"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a
                href="https://www.amazon.in/s?i=stripbooks&rh=p_27%3APEP%2BTALK%2BINDIA&ref=dp_byline_sr_book_1"
                target="_blank"
                className="p-3 rounded-full bg-white text-gray-700 group transition-all duration-500 hover:bg-amber-500 hover:text-white focus-within:outline-0 focus-within:bg-amber-500 focus-within:text-white"
              >
                <FaAmazon />
